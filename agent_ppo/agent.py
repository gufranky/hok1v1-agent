...
from agent_ppo.feature.raw_state import build_parsed_state, camp_to_int
...
class Agent(BaseAgent):
    ...
    def reset(self, observation):
        ...
        # 重置函数，每局开始时调用
        self.hero_camp = camp_to_int(observation["player_camp"])
    ...
    def observation_process(self, observation):
        self.parsed_state = build_parsed_state(observation)
        feature = self.obs_builder.build_observation(self.parsed_state)
